...
-- Дамп структуры для таблица world3.3.5_beta.playercreateinfo_cast_spell
...
-- Дамп данных таблицы world3.3.5_beta.playercreateinfo_cast_spell: ~2 rows (приблизительно)
