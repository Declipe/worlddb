...
-- Дамп структуры для таблица world3.3.5_beta.quest_greeting
...
-- Дамп данных таблицы world3.3.5_beta.quest_greeting: ~184 rows (приблизительно)
