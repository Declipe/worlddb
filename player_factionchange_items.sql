...
-- Дамп структуры для таблица world3.3.5_beta.player_factionchange_items
...
-- Дамп данных таблицы world3.3.5_beta.player_factionchange_items: ~1 355 rows (приблизительно)
