...
-- Дамп структуры для таблица world3.3.5_beta.playercreateinfo_spell_custom
...
-- Дамп данных таблицы world3.3.5_beta.playercreateinfo_spell_custom: ~460 rows (приблизительно)
