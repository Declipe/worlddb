...
-- Дамп структуры для таблица world3.3.5_beta.itemextendedcostdbc
CREATE TABLE IF NOT EXISTS `itemextendedcostdbc` (
...
-- Дамп данных таблицы world3.3.5_beta.itemextendedcostdbc: 975 rows
/*!40000 ALTER TABLE `itemextendedcostdbc` DISABLE KEYS */;
INSERT INTO `itemextendedcostdbc` (`Id`, `ReqHonorPoints`, `ReqArenaPoints`, `ReqArenaSlot`, `ReqItem1`, `ReqItem2`, `ReqItem3`, `ReqItem4`, `ReqItem5`, `ReqItemCount1`, `ReqItemCount2`, `ReqItemCount3`, `ReqItemCount4`, `ReqItemCount5`, `ReqPersonalArenaRating`, `PurchaseGroup`) VALUES
	...
	(2998, 0, 0, 0, 37711, 0, 0, 0, 0, 100, 0, 0, 0, 0, 0, 0),
	(3000, 0, 0, 0, 38644, 0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0),
	(4000, 0, 0, 0, 37742, 0, 0, 0, 0, 100, 0, 0, 0, 0, 0, 0);
/*!40000 ALTER TABLE `itemextendedcostdbc` ENABLE KEYS */;
