...
-- Дамп структуры для таблица world3.3.5_beta.game_event_seasonal_questrelation
...
-- Дамп данных таблицы world3.3.5_beta.game_event_seasonal_questrelation: ~690 rows (приблизительно)
