...
--
-- Table structure for table `grumboz_wctf_flag_gps`
--
...
--
-- Dumping data for table `grumboz_wctf_flag_gps`
--

LOCK TABLES `grumboz_wctf_flag_gps` WRITE;
/*!40000 ALTER TABLE `grumboz_wctf_flag_gps` DISABLE KEYS */;
/*!40000 ALTER TABLE `grumboz_wctf_flag_gps` ENABLE KEYS */;
UNLOCK TABLES;
