...
-- Дамп структуры для таблица world3.3.5_beta.creature_template_npcbot_appearance
...
-- Дамп данных таблицы world3.3.5_beta.creature_template_npcbot_appearance: ~284 rows (приблизительно)
