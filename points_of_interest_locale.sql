...
-- Дамп структуры для таблица world3.3.5_beta.points_of_interest_locale
...
-- Дамп данных таблицы world3.3.5_beta.points_of_interest_locale: ~2 977 rows (приблизительно)
