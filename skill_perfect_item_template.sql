...
-- Дамп структуры для таблица world3.3.5_beta.skill_perfect_item_template
...
-- Дамп данных таблицы world3.3.5_beta.skill_perfect_item_template: ~72 rows (приблизительно)
