...
-- Дамп структуры для таблица world3.3.5_beta.trainer
...
-- Дамп данных таблицы world3.3.5_beta.trainer: ~138 rows (приблизительно)
INSERT INTO `trainer` (`Id`, `Type`, `Requirement`, `Greeting`, `VerifiedBuild`) VALUES
	...
	(60611, 0, 2, 'Hello, Paladin!  Ready for some training?', 0),
	(60612, 0, 8, 'Hello, Mage!  Ready for some training?', 0),
	(60613, 0, 5, 'Hello, Priest!  Ready for some training?', 0),
	(60614, 0, 7, 'Hello, Shaman!  Ready for some training?', 0),
	(60615, 0, 1, 'Hello, Warrior!  Ready for some training?', 0),
	(60616, 0, 3, 'Hello, Hunter!  Ready for some training?', 0),
	(60617, 0, 4, 'Hello, Rogue!  Ready for some training?', 0),
	(60618, 0, 9, 'Hello, Warlock!  Ready for some training?', 0),
	(60619, 0, 11, 'Hello, Druid!  Ready for some training?', 0),
	(60620, 0, 6, 'Hello, Death Knight!  Ready for some training?', 0),
	(60621, 2, 0, 'Hello!  Can I teach you something?', 0),
