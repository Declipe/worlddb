...
-- Дамп структуры для таблица world3.3.5_beta.skill_extra_item_template
...
-- Дамп данных таблицы world3.3.5_beta.skill_extra_item_template: ~225 rows (приблизительно)
